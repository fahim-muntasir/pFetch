...
export const DASHBOARD_SIDEBAR_LINKS = [
  {
    ...
    label: 'タスク一覧',
    path: '/',
    icon: <img src={Icon1} alt="icon1" className="h-[41px] w-[41px]" />,
  },
  {
    key: 'サイト毎の設定',
    label: 'サイト毎の設定',
    path: '/サイト毎の設定',
    icon: <img src={Icon2} alt="icon2" className="h-[41px] w-[41px]" />,
    submenu: [
  ...
  },
  {
    ...
    label: 'アカウント一覧',
    path: '/アカウント一覧',
    icon: <img src={Icon3} alt="icon3" className="h-[41px] w-[41px]" />,
	submenu: [
  ...
  },
  {
    ...
    label: 'クレジットカード一覧',
    path: '/クレジットカード一覧',
    icon: <img src={Icon4} alt="icon4" className="h-[41px] w-[41px]" />,
  },
  {
    key: 'Proxy一覧',
    label: 'Proxy一覧',
    path: '/Proxy一覧',
    icon: <img src={Icon5} alt="icon5" className="h-[41px] w-[41px]" />,
  },
];
